...
if ( ! defined( 'ELEGANT_PINK_THEME_VERSION' ) && ! defined( 'ELEGANT_PINK_THEME_NAME' ) && ! defined( 'ELEGANT_PINK_THEME_TEXTDOMAIN' ) ) {
    $theme_data = wp_get_theme();   
    define( 'ELEGANT_PINK_THEME_VERSION', $theme_data->get( 'Version' ) );
    define( 'ELEGANT_PINK_THEME_NAME', $theme_data->get( 'Name' ) );
    define( 'ELEGANT_PINK_THEME_TEXTDOMAIN', $theme_data->get( 'TextDomain' ) );
}
